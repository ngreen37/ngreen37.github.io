...
### What's next:
  ...
  - Ed Nightingdale is credited, I believe, for the idea that one hour spent on something daily can make you an expert in five years or less.  Can't guarantee it's accuracy but I like that.  Perhaps the idea is that if you commit to an hour each day, you'll often do more than that.  Because one hour each day is only 1,825 hours.
