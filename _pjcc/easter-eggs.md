...
**Trigger:** none — a **15% chance** on each load of the front door (`/` since the 2026-07-21 flip; was `/pjcc/`) (once per session; skipped if you have reduced-motion on, or if the site is already set to Japanese).
