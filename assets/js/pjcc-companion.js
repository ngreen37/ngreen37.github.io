...
(function () {
  ...
  var NAMES = { 'cipher':'CIPHER','clearance-delta':'Clearance: DELTA','notation-run':'Notation Blitz','fork-in-the-road':'Fork in the Road','sand-mine-depths':'Sand Mine Depths','pirc-protocol':'Pirc Protocol','ferry-delayed':'Ferry Delayed','shogi-island':'Shogi Island','blindfold':'Blindfold Puzzles','tower-defense':'Siege on Chess City' };
