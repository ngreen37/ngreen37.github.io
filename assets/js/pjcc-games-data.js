...
window.PJCC_GAMES = [
  ...
  // workbench and give them links the same way") — "the same way" = the way
  // Duel is handled, further down the list: `playable:false` so the
  ...
  // Checker Town (2026-09-02) — the Godot town, web-exported; the page is at
  // games/checker-town/index.html and the build is generated by `npm run gen:checkertown`.
  // ⛑ ON THE SITE 2026-09-07 (Nate: *"let's get Checker town on the site. put it on the
  // workbench"*). Same swap as Campaign above: off the typed key, onto the earned one.
  { slug:'checker-town',      name:'Checker Town',       cryptic:'Sixteen empty squares and a road south', icon:'⌂', accent:'#8fd6a0', cat:'dev', gate:'nrun' },
