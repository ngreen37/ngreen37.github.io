...
<div class="vl-type">
  <div class="vl-type-row">
    ...
    <div class="vl-type-meta"><b>Poppins</b> <span class="vl-brand vl-brand--both">Both brands</span> · display &amp; headings · 400/600/700/800<br>
      <span class="vl-not">Never body copy — it loses legibility below about 15px.</span></div>
  </div>
  <div class="vl-type-row">
    ...
    <div class="vl-type-meta"><b>Inter</b> <span class="vl-brand vl-brand--both">Both brands</span> · body copy, and the default for every page · 400/500/600<br>
      <span class="vl-not">The one face that never needs a reason. If a block of text has no argument for being anything else, it is Inter.</span></div>
  </div>
  <div class="vl-type-row">
  ...
  <div class="vl-type-row">
    <div class="vl-type-sample" style="font-family:'Press Start 2P',monospace;font-size:0.72rem;line-height:1.9;color:#3cbcfc">PRESS START<br>HIGH SCORE 0064</div>
    <div class="vl-type-meta"><b>Press Start 2P</b> <span class="vl-brand vl-brand--arcade">The arcade</span> · cabinet type — Murphy's Law and the card that opens it<br>
      <span class="vl-not">One game and its door, on purpose. It is a costume, and a costume worn everywhere is a uniform.</span></div>
  </div>
  <div class="vl-type-row">
    <div class="vl-type-sample" style="font-family:'Iowan Old Style','Palatino Linotype','Book Antiqua',Palatino,Georgia,serif;font-style:italic;font-size:1.15rem;color:#ffe6c0">Made slowly, in the open, by one person.</div>
    <div class="vl-type-meta"><b>The studio serif</b> <span class="vl-brand vl-brand--mcp">McPuppy Studios</span> · asides and captions on the studio side · system stack, italic<br>
      <span class="vl-not">Iowan Old Style → Palatino → Book Antiqua → Georgia. No file to download: it borrows whatever good serif the reader already owns.</span></div>
  </div>
  <div class="vl-type-row">
...
<p class="vl-note">The rule underneath all of it: <b>a face is a voice, not a decoration.</b> Adding a seventh means answering who is talking that none of these six can speak for — and every face here is either already on the reader's machine or a woff2 we host ourselves, so nothing on this site waits on a font server.</p>
...
.vl-type-meta { color: #9a7fd4; font-size: 0.82rem; line-height: 1.6; }
.vl-type-meta b { color: #f0e6ff; }
/* the brand chip — which of the two brands owns this face. Bordered rather than filled:
   a solid chip beside a type SAMPLE competes with the sample, which is the thing to look at. */
.vl-brand {
  display: inline-block; font-family: 'Share Tech Mono', monospace; font-size: 0.7rem;
  letter-spacing: 0.1em; text-transform: uppercase; padding: 1px 7px; border-radius: 3px;
  border: 1px solid currentColor; vertical-align: 1px; margin-left: 4px;
}
.vl-brand--both   { color: #c9a7ff; }
.vl-brand--pjcc   { color: #6bffb8; }
.vl-brand--mcp    { color: #e8d6bb; }
.vl-brand--arcade { color: #3cbcfc; }
/* "and where it is NOT used" — the half of a type chart that actually prevents drift */
.vl-not { display: inline-block; margin-top: 3px; color: #8b74c4; }
.vl-not em { color: #c9b6ef; font-style: italic; }
