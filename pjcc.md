...
{% comment %} `full-sky` (2026-07-21) opts this page into the WHOLE town sky — the cloud
     ...
     only the splash was allowed to show. The discrete layers fade out as the hero
     scrolls away, so they never end up floating behind body copy. (They were blamed for
     the "jellybeans" on 2026-07-15; that was wrong — those were footer weathering splats,
     deleted 2026-07-22.) See THE SKY VEIL at the foot of
     _sass/_pjcc-20-town-sky.scss, and docs/front-door-2026-07-21.md for why this page is
     being built up into the site's one front door. {% endcomment %}
