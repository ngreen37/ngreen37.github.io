...
<div class="ac-class-row">
  ...
  <button class="ac-print-btn" id="ac-print-work">🖨 Print worksheet</button>
  <button class="ac-print-btn" id="ac-print-teacher">🖨 Teacher progress sheet</button>
  <button class="ac-print-btn ac-print-cert" id="ac-print-cert">🏅 Print my certificate</button>
</div>

<!-- ===== Printable sheets (hidden on screen) ===== -->
<div class="ac-print" id="sheet-worksheet">
  <div class="ws-head"><span>Checker Town Chess Academy</span><span id="ws-name-1">Name: ____________________</span></div>
  <h1 class="ws-title">Coordinate Quest — Worksheet 1</h1>
...
(function () {
  ...
  var BELTS = [
    ...
    { n: 'Rook', ico: '♖', need: 11 },
    { n: 'Queen', ico: '♕', need: 14 },
    { n: 'Chess City Citizen', ico: '♚', need: 15 }
  ];
